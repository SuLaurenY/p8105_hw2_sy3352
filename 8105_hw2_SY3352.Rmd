...
The table above shows the 10 zip codes that experienced the largest rent drop from Jan 2020 to Jan 2021 due to the impact of covid-19. The relevant borough name and neighborhood are also displayed in the table. All these zip codes are in New York county, indicating that the most populated area also expereinced the largest impact of covid in terms of rent.